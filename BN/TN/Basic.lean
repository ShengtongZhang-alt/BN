...
instance {r : ℕ} : DecidablePred fun f : Fin r → Fin 3 ↦ StrictMono f := by
  classical
  infer_instance
...
lemma det_mul_eq_sum_strictMono_width3 {r : ℕ}
  ...
  | 3 =>
    haveI : Subsingleton (StrictMonoFin3 3) :=
  ...
  | r + 4 =>
    ...
    haveI := isEmpty_strictMonoFin3_of_three_lt hr
