...
import BN.Kernel.Bilinear
import BN.Kernel.Signs
import BN.Kernel.N
import BN.CP.Basic
...
lemma kernel_gram_eq {κ : Type*} [Fintype κ] [DecidableEq κ]
...
lemma kernel_gram_isCompletelyPositive {κ : Type*} [Fintype κ] [DecidableEq κ]
