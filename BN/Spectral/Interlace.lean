...
/-- Euclidean inner product on coordinate space. Avoids the `BN.inner` name clash. -/
...
lemma exists_l2_mem_span_single_pair_orthogonal (hA : A.IsHermitian)
  ...
  have hy0 : y ≠ 0 := by
    ...
    · intro hy
      ...
      simp [Pi.single_eq_same, Pi.single_eq_of_ne hij, Pi.single_eq_of_ne hij.symm] at hi hj
      exact hu ⟨hj, hi⟩
